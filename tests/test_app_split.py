...
# sidebar's 9 view actions (larmor/desktop/addline_toolbar.py, wip/WB) + the
# open-windows bar strip at its bottom (one text-less widget action; its
# buttons are QToolButtons, not actions -- larmor/desktop/windowtray.py, wip/WD)
TOOLBAR_ACTIONS = 19
