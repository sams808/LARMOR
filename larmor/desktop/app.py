...
from PySide6.QtWidgets import (QApplication, QDockWidget, QFileDialog, QLabel,
                               ...
                               QStackedWidget, QTableWidget, QToolBar,
...
class MainWindow(_FilesMixin, _SessionMixin, _OverlaysMixin, _EditingMixin,
                 _SidebandsMixin, _FittingMixin, _ProcessingMixin, _CofitMixin,
                 _ToolsMixin, QMainWindow):
    def __init__(self):
        super().__init__()
